...
Public Class frmRouteFinder
    ...
    Public Function MinMax(ByVal newNode As String, ByVal depth As Integer) As Integer
        ...
        Dim minimumValue As Integer = 1000000000
        Dim maximumValue As Integer = -1000000000
            ...
            If n.node.Equals(newNode) Then
                ...
                ElseIf n.minmaxLevel.Equals("min") Then
                    ...
                    For Each child In n.successors
                        ...
                        'minimumValue = MinMax(child, depth + 1)
                        If childValue.ContainsKey(newNode) = False Then
                            childValue.Add(newNode, minimumValue)
                ...
                ElseIf n.minmaxLevel.Equals("max") Then
                    ...
                    For Each child In n.successors
                        ...
                        'maximumValue = MinMax(child, depth + 1)
                        If childValue.ContainsKey(newNode) = False Then
                            childValue.Add(newNode, maximumValue)
                            'ElseIf childValue.ContainsKey(n.node) = False Then
                            '    childValue.Add(n.node, maximumValue)
    ...
    Private Sub btnBrowse_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBrowse.Click
        ...
        OpenFileDialog1.FileName = "C:\Routes3.txt"
